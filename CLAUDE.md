...
└── i18n/           # Localization (en, de, es, fr, it, ja, nb, nl, pl, pt-BR, sv, uk)
```
...
Add keys to `en.ts` first, then all locale JSONs. Run `pnpm run check:i18n`. Locales: de, en, es, fr, it, ja, nb, nl, pl, pt-BR, sv, uk.
