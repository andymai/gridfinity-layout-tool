...
| `category`         | `string`                                | yes      |         | length >= 1          | Category id. MUST match an id in the categories array; a dangling reference fails import.                                                                                                  |
| `label`            | `string`                                | yes      |         | length <= 24         | Short bin label. Required, but may be an empty string.                                                                                                                                     |
| `notes`            | `string`                                | yes      |         | length <= 256        | Longer note. Required, but may be an empty string.                                                                                                                                         |
