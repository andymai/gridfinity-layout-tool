...
| `folderId`          | `string` \| `null`                    |          |          |                           | Library folder holding the layout, present only on the cloud sync wire. The library entry is authoritative; exports and shares omit it, and the importer ignores it.                                                                           |
