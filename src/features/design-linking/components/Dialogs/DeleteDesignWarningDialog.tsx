    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 id="delete-warning-title" className="text-xl font-semibold text-content">
            {t('designLinking.deleteWarning.title')}
          </h2>
        </div>

        <p id="delete-warning-description" className="mb-4 text-sm text-content-secondary">
        ...
        <div className="flex gap-3 justify-end">
          <button ref={cancelButtonRef} onClick={handleCancel} className="btn btn-secondary">
            {t('common.cancel')}
          </button>
