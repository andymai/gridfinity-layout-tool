...
describe('LayoutPreviewOverlay', () => {
  ...
  describe('drawer comparison', () => {
    ...
    it('shows size info when drawer sizes differ', () => {
      ...
      expect(
        screen.getByText((content) => content.includes('10×8') && content.includes('drawer'))
      ).toBeInTheDocument();
  ...
  describe('related layouts', () => {
    it('shows related layouts section', () => {
      ...
      expect(
        screen.getByText((content) => content.includes('More') && content.includes('Workshop'))
      ).toBeInTheDocument();
    });
  ...
  describe('import state', () => {
    it('shows normal button when not importing', () => {
      ...
      expect(
        screen.getByText((content) => content.includes('Use as Starting Point'))
      ).toBeInTheDocument();
  ...
  describe('footer', () => {
    it('displays helpful text', () => {
      ...
      expect(
        screen.getByText(
          (content) =>
            content.includes('Use as a starting point') &&
            content.includes('customize to fit your items')
        )
      ).toBeInTheDocument();
    });
  });
