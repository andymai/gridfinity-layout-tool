...
/**
 * Deliberately unequal compartments — the one thing that distinguishes a bento
 * from {@link Grid3x3Icon}'s uniform grid at 20px.
 */
export function BentoIcon({ size = 20, className = '' }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
