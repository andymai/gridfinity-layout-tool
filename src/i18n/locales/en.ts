...
const en: Record<string, string> = {
  ...
  'binDesigner.walls.pattern.honeycomb': 'Honeycomb walls',
  ...
  'binDesigner.insertsCount': '{count} insert(s)',
  'binDesigner.addFromLibrary': 'Add from cutout library',
  'binDesigner.selectCutout': 'Select a cutout',
  'binDesigner.noCustomCutouts': 'No cutouts in library. Trace a tool photo first.',
  ...
  'binDesigner.insertShape.hexagon': 'Hexagon',
  ...
  'binDesigner.rotationDegrees': '{degrees}°',
