...
const en: Record<string, string> = {
  ...
  'baseplate.fitToDrawer': 'Fit to Drawer',
  'baseplate.drawerWidth': 'Drawer width',
  'baseplate.drawerDepth': 'Drawer depth',
  'baseplate.gridUses': '{gridMm}mm grid',
  'baseplate.remaining': '{remainderMm}mm remaining',
  'baseplate.noRemaining': 'No remaining space',
  'baseplate.drawerTooSmall': 'Drawer is smaller than grid',
  'baseplate.alignStart': 'Align start',
  'baseplate.alignCenter': 'Center',
  'baseplate.alignEnd': 'Align end',
  'baseplate.paddingSummary': 'Padding: {left}+{right} × {front}+{back}mm',
