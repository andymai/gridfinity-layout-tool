...
const en: Record<string, string> = {
  ...
  'scan.instructions':
    'Lay your tool next to a bank card on a plain surface, then snap a photo from any angle — the card sets the exact size.',
  ...
  'scan.sent.title': 'Sent!',
  'scan.sent.body': 'Return to your computer — the outline is on its way to the bin designer.',
