...
const en: Record<string, string> = {
  ...
  'layouts.folders.all': 'All layouts',
  'layouts.folders.tree': 'Folders',
  'layouts.folders.newFolder': 'New folder',
  'layouts.folders.newSubfolder': 'New folder in {name}',
  'layouts.folders.namePlaceholder': 'Folder name',
  'layouts.folders.create': 'Create',
  'layouts.folders.rename': 'Rename folder',
  'layouts.folders.delete': 'Delete folder',
  'layouts.folders.deleteConfirm': 'Delete?',
  'layouts.folders.deleteHint': 'Its layouts and folders move up a level.',
  'layouts.folders.moveTo': 'Move to folder',
  'layouts.folders.moveTitle': 'Move "{name}"',
  'layouts.folders.noFolder': 'No folder',
  'layouts.folders.move': 'Move',
  'layouts.folders.empty': 'Nothing in this folder yet',
  'layouts.folders.emptyHint': 'Move layouts here from their menu, or add a folder inside it.',
  'layouts.folders.breadcrumb': 'Folder path',
  'layouts.folders.open': 'Open folder {name}',
  'layouts.folders.moreActions': 'Folder actions for {name}',
  'layouts.folders.itemCount.one': '1 layout',
  'layouts.folders.itemCount.other': '{count} layouts',
  'layouts.folders.saveFailed': 'Could not save the folder change',
  'layouts.folders.movedTo': 'Moved to {name}',
  'layouts.folders.movedToRoot': 'Moved out of its folder',
  'layouts.folders.expand': 'Expand',
  'layouts.folders.collapse': 'Collapse',
  ...
  'binDesigner.plateIcon.group.kitchen': 'Kitchen',
  ...
  'binDesigner.plateIcon.screwdriverBit': 'Screwdriver bit',
  'binDesigner.plateIcon.teaspoon': 'Teaspoon',
  'binDesigner.plateIcon.tablespoon': 'Tablespoon',
  'binDesigner.plateIcon.fork': 'Fork',
  'binDesigner.plateIcon.knife': 'Knife',
  'binDesigner.plateIcon.spatula': 'Spatula',
  'binDesigner.plateIcon.whisk': 'Whisk',
  'binDesigner.plateIcon.tongs': 'Tongs',
  'binDesigner.plateIcon.ladle': 'Ladle',
  'binDesigner.plateIcon.chopsticks': 'Chopsticks',
  'binDesigner.plateIcon.bottleOpener': 'Bottle opener',
  'binDesigner.plateIcon.peeler': 'Peeler',
  'binDesigner.plateIcon.rollingPin': 'Rolling pin',
  ...
  'binDesigner.lid.compat.fix.hingeUnbuildable': 'move the hinge to a wall with an unbroken rim',
  ...
  'binDesigner.detachableFeet.pinHint':
    'Widest diameter; the hole is 3mm. Step down a size if a foot will not seat, up a size if it works loose.',
  ...
  'binDesigner.category.rail': 'Panel sections',
  'binDesigner.category.selection': 'Selection',
  'binDesigner.category.shape': 'Shape',
  'binDesigner.category.interior': 'Interior',
  ...
  'binDesigner.panel.viewAsScroll': 'Single scroll',
  'binDesigner.panel.viewAsRail': 'Compact sections',
  ...
  'binDesigner.cutouts.knifePreset.chefWood': 'Chef (wood)',
  ...
  'binDesigner.cutouts.knifeHandleWidth': 'Handle W',
  'binDesigner.cutouts.knifeHandleHeight': 'Handle H',
  'binDesigner.cutouts.knifeOrientation': 'Orientation',
  'binDesigner.cutouts.knifeOrientation.horizontal': 'Horizontal',
  'binDesigner.cutouts.knifeOrientation.vertical': 'Vertical',
  ...
  'binDesigner.base.bodyType.nesting': 'Nesting',
  'binDesigner.base.bodyType.nesting.description':
    'One continuous tapered base with a bed-supported floor',
  'binDesigner.base.nesting.hint':
    'Nests in the stacking lip of a bin the same size. The continuous base does not fit a Gridfinity baseplate.',
  'binDesigner.base.nesting.magnetHint':
    'Magnet size is shared with the lid. Choose a magnetic lid for matching pockets at the top.',
  'binDesigner.base.nesting.floorFeaturesUnavailable':
    'Not available with the lowered Nesting floor',
