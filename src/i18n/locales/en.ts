...
const en: Record<string, string> = {
  ...
  'baseplate.dovetails.invertTooltip': 'Click a piece to swap its tongues and grooves',
  'baseplate.dovetails.invertAll': 'Invert all',
  'baseplate.dovetails.inverted': 'Inverted',
