...
const en: Record<string, string> = {
  ...
  'binDesigner.group.eco': 'Eco Mode',
  'binDesigner.eco.title': 'Eco Mode',
  'binDesigner.eco.applyPreset': '⚡ Apply Eco Preset',
  'binDesigner.eco.savings': 'Saves ~{percent}% filament',
  'binDesigner.eco.honeycombFloor': 'Honeycomb floor',
  'binDesigner.eco.honeycombWalls': 'Honeycomb walls',
  'binDesigner.eco.waveWalls': 'Wave walls',
  'binDesigner.eco.cellSize': 'Cell size',
  'binDesigner.eco.margin': 'Edge margin',
  'binDesigner.eco.topMargin': 'Top margin',
  'binDesigner.eco.bottomMargin': 'Bottom margin',
  'binDesigner.eco.pocketed': 'Pocketed',
  'binDesigner.eco.perforated': 'Perforated',
  'binDesigner.eco.amplitude': 'Amplitude',
  'binDesigner.eco.frequency': 'Frequency',
  'binDesigner.eco.baseThickness': 'Base thickness',
  ...
  'binList.headerSummary': '{bins} bins · {filament}m',
  ...
  'binList.piecesCount': '{count} pieces',
  ...
  'binList.setLabelForBins': 'Set label for {count} bins',
  'binList.setLabelForCount': 'Set label for {count} bins',
  'binList.setNotesForBins': 'Set notes for {count} bins',
  ...
  'binList.splitIntoPieces': 'Split into {count} pieces',
  'binList.spoolUsage': 'Spool usage',
  'binList.spoolUsageValue': '{spools} spools ({pct}%)',
