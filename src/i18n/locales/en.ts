...
const en: Record<string, string> = {
  ...
  'baseplate.overTile': 'Fill padding with grid (over-tile)',
  'baseplate.overTileHint':
    'Replace the solid padding margin with clipped grid tiles. A leftover too small to print falls back to solid padding.',
