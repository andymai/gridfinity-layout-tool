...
const en: Record<string, string> = {
  ...
  'binDesigner.angledDividers.endpointTop': 'Top',
  'binDesigner.angledDividers.endpointBottom': 'Bottom',
  'binDesigner.angledDividers.endpointLeft': 'Left',
  'binDesigner.angledDividers.endpointRight': 'Right',
  'binDesigner.angledDividers.emptyHeading': 'Tilt dividers diagonally for angled compartments.',
  'binDesigner.angledDividers.emptyCta': 'Click a divider on the canvas to start.',
  'binDesigner.angledDividers.helpButtonLabel': 'About diagonal dividers',
  'binDesigner.angledDividers.infoBody':
    'Tilt interior walls to create wedge-shaped compartments. Click a divider on the canvas to select it, then adjust the two endpoint offsets.',
  ...
  'baseplate.connectorStyle.dovetail': 'Dovetail (slide-in)',
  'baseplate.connectorStyle.bowtie': 'Bowtie key (hammer-in)',
