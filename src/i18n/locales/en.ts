...
const en: Record<string, string> = {
  ...
  'binDesigner.inspector.title': 'Inspector',
  'binDesigner.inspector.expand': 'Expand inspector',
  'binDesigner.inspector.collapse': 'Collapse inspector',
  'binDesigner.inspector.selection.title': 'Selection',
  'binDesigner.inspector.selection.clear': 'Clear selection',
  'binDesigner.inspector.compartment.title': 'Compartment {n}',
  'binDesigner.inspector.compartment.span': '{w} × {h} cells',
  'binDesigner.inspector.compartment.label': 'Label',
  'binDesigner.inspector.compartment.labelPlaceholder': 'e.g. Screws',
  'binDesigner.inspector.divider.title': 'A divider is selected.',
  'binDesigner.inspector.divider.editTilt': 'Edit tilt',
  'binDesigner.inspector.estimates.title': 'Print estimate',
  'binDesigner.inspector.estimates.filament': 'Filament',
  'binDesigner.inspector.estimates.weight': 'Weight',
  'binDesigner.inspector.estimates.time': 'Print time',
  'binDesigner.inspector.estimates.cost': 'Cost',
  'binDesigner.inspector.estimates.triangles': 'Triangles',
  'binDesigner.inspector.warnings.title': 'Warnings',
  'binDesigner.inspector.warnings.none': 'No issues detected.',
  'binDesigner.inspector.warnings.fix': 'Fix',
  'binDesigner.inspector.warnings.meshError': 'Geometry failed to generate.',
  'binDesigner.inspector.warnings.split': 'Splits into {count} pieces to fit the bed.',
  'binDesigner.inspector.export.title': 'Export',
  'binDesigner.inspector.export.format': 'Format',
  'binDesigner.inspector.export.pieces': 'Pieces',
  'binDesigner.inspector.export.action': 'Export…',
  ...
  'baseplate.overTile': 'Fill padding with grid',
