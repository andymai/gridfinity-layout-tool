...
const en: Record<string, string> = {
  ...
  'binDesigner.handles.depth': 'Depth',
  'binDesigner.handles.filletRadius': 'Fillet radius',
  'binDesigner.handles.backDisabledByLabelTab': 'Back handle disabled — label tab active',
  'binDesigner.handles.summary': '{sides}: {depth}mm deep',
  'binDesigner.handles.unavailableSlotted': 'Not available for slotted bins',
  'binDesigner.tabSupport.fillet': 'Fillet',
