...
const en: Record<string, string> = {
  ...
  'binDesigner.flatFloorDisablesLightweight': 'Flat floor has no socket to lighten',
  'binDesigner.lightweightDisablesFlatFloor': 'Cannot combine lightweight base with flat floor',
