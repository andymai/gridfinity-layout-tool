...
const en: Record<string, string> = {
  ...
  'binDesigner.lid.magnetHoles': 'Magnet holes',
  'binDesigner.lid.wallThickness': 'Side wall thickness',
  'binDesigner.lid.topThickness': 'Top thickness',
  ...
  'binDesigner.lid.compat.shortBin':
    'Bin is 1U tall — the lid still seats but click engagement is marginal.',
  ...
  'binDesigner.lid.compat.cellMaskHoles':
    'Custom shape has interior holes — those inner edges have lip but no click rails (asymmetric click).',
