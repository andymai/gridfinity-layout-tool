...
const en: Record<string, string> = {
  ...
  'baseplate.connectors.tooltip':
    'How adjacent baseplate pieces stay aligned. Dovetails are integral; snap clips print separately.',
  'baseplate.connectors.none': 'None',
  'baseplate.connectors.dovetail': 'Dovetail',
  'baseplate.connectors.snap': 'Snap clip',
  'baseplate.snapClipLifted': 'Lifted',
  'baseplate.snapClipSeated': 'Seated',
  'baseplate.snapClipExplodeSlider': 'Lift snap clips for inspection',
