...
const en: Record<string, string> = {
  ...
  'binDesigner.quarterFeetRequires1x1': 'Quarter-sized feet require bins at least 1×1 unit',
  'binDesigner.quarterFeetDisablesMagnetHoles': 'Quarter-sized feet do not support magnet holes',
  'binDesigner.quarterFeetDisablesScrewHoles': 'Quarter-sized feet do not support screw holes',
  'binDesigner.quarterFeetDisablesFlatFloor': 'Cannot combine quarter-sized feet with flat floor',
  'binDesigner.flatFloorDisablesQuarterFeet': 'Flat floor disables quarter-sized feet',
