...
const en: Record<string, string> = {
  ...
  'settings.gridVisuals': 'Grid Visuals',
  'settings.gridShowLines': 'Show grid lines',
  'settings.gridShowHalfLines': 'Show half-bin lines',
  'settings.gridLineOpacity': 'Grid line opacity',
