...
import {
  ...
  COMMUNITY_PRINT_THUMB_MAX_BYTES as API_THUMB_MAX_BYTES,
  COMMUNITY_PRINT_THUMB_MAX_EDGE_PX as API_THUMB_MAX_EDGE_PX,
...
describe('print limits (cross-boundary mirror)', () => {
  it('matches every scalar limit', () => {
    ...
    expect(COMMUNITY_PRINT_THUMB_MAX_EDGE_PX).toBe(API_THUMB_MAX_EDGE_PX);
    expect(COMMUNITY_PRINT_THUMB_MAX_BYTES).toBe(API_THUMB_MAX_BYTES);
  });
