      ...
      >
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin p-6">
          ...
          <Link
            to="/guide"
            onClick={onClose}
            className="mb-6 flex items-center gap-4 p-4 rounded-lg bg-accent/10 border border-accent/20 hover:bg-accent/15 transition-colors group"
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="font-medium text-accent">Interactive Guide</div>
              <div className="text-sm text-content-secondary">Learn the basics with hands-on tutorials</div>
            </div>
            <svg className="w-5 h-5 text-accent opacity-60 group-hover:opacity-100 group-hover:translate-x-1 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor">
