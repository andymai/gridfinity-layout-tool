...
export function MobileHeader({ onMenuClick, onHelpClick }: MobileHeaderProps) {
  const { t } = useTranslation(['layout', 'aria', 'common', 'help']);
  ...
  return (
    <div className="flex-shrink-0">
      ...
      <div className="h-7 flex items-center justify-between px-3 bg-surface border-b border-stroke-subtle">
        <span className="text-xs font-medium text-content-secondary">{t('layout:mobile.header.appTitle')}</span>
        <a
      ...
      <button
        ...
        aria-label={t('layout:mobile.header.openSettings')}
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          aria-label={t('layout:mobile.nav.layers')}
        >
        ...
        <button
          ...
          className="landscape-nav-button btn btn-ghost btn-icon"
          aria-label={t('aria:panels.inspector')}
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          ...
          className="landscape-nav-button btn btn-ghost btn-icon"
          aria-label={t('layout:mobile.nav.categories')}
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          ...
          className="landscape-nav-button btn btn-ghost btn-icon"
          aria-label={t('layout:mobile.nav.list')}
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="flex-1 mx-3 min-w-0">
        {isEditing ? (
          ...
          <button
            ...
            aria-label={t('layout:mobile.header.openLayouts')}
          >
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          disabled={!canUndo}
          className="btn btn-ghost btn-icon"
          aria-label={t('aria:buttons.undo')}
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          ...
          disabled={!canRedo}
          className="btn btn-ghost btn-icon"
          aria-label={t('aria:buttons.redo')}
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <button
          onClick={onHelpClick}
          className="btn btn-ghost btn-icon"
          aria-label={t('layout:mobile.header.helpAndGestures')}
          title={t('help:title')}
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
