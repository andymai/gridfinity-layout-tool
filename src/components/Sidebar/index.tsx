  ...
  return (
    ...
    >
      {collapsed ? (
        ...
        <div className="flex flex-col items-center py-3">
          <button
            ...
            aria-label={t('aria:actions.expandLeftPanel')}
          >
        ...
        <>
          <div className="flex items-center gap-3 px-4 py-3 border-b border-stroke-subtle">
            ...
            <button
              ...
              aria-label={t('aria:actions.collapseLeftPanel')}
            >
              <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div className="flex-1 overflow-y-auto scrollbar-thin flex flex-col">
              ...
              <div className="text-xs text-content-secondary space-y-2">
                <div className="flex items-center justify-between">
                  <label
                    ...
                    title={t('layout:gridSettings.gridWidthHint')}
                  >
                    {t('layout:gridSettings.gridWidth')}
                  </label>
                  <div className="flex items-center gap-1">
                    ...
                    />
                    <span className="text-content-tertiary">{t('common:units.gridUnit', { count: drawerWidth }).replace(String(drawerWidth), '').trim()}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="gridDepth"
                    className="text-content-tertiary"
                    title={t('layout:gridSettings.gridDepthHint')}
                  >
                    {t('layout:gridSettings.gridDepth')}
                  </label>
                  <div className="flex items-center gap-1">
                    <DeferredNumberInput
                      id="gridDepth"
                      ...
                      className="input w-12 py-0.5 px-1 text-xs text-right"
                    />
                    <span className="text-content-tertiary">{t('common:units.gridUnit', { count: drawerDepth }).replace(String(drawerDepth), '').trim()}</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span
                    className="text-content-tertiary"
                    title={t('layout:gridSettings.maxHeightHint')}
                  >
                    {t('layout:drawer.maxHeight')}
                  </span>
                  <div className="flex items-center gap-1">
                    <button
                ...
                <div className="flex items-center justify-between">
                  <label
                    ...
                    className="text-content-tertiary"
                    title={t('layout:gridSettings.printBedHint', { maxUnits: calcMaxGridUnits(printBedSize, gridUnitMm) })}
                  >
                ...
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="gridUnit"
                    className="text-content-tertiary"
                    title={t('layout:gridSettings.oneGridUnitHint')}
                  >
                ...
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="heightUnit"
                    className="text-content-tertiary"
                    title={t('layout:gridSettings.oneUnitHeightHint')}
                  >
                ...
                <label className="flex items-center justify-between pt-2 mt-2 border-t border-stroke-subtle cursor-pointer">
                  <div className="flex items-center gap-1.5">
                    <span
                      className="text-content-tertiary"
                      title={t('layout:gridSettings.halfBinModeHint')}
                    >
                      {t('layout:gridSettings.halfBinMode')}
                    </span>
            ...
            <div className="px-4 py-4 border-t border-stroke-subtle">
              ...
              <div className="text-xs text-content-secondary space-y-1 mb-3">
                <div>{t('layout:defaults.drawer', { width: settings.defaultDrawerWidth, depth: settings.defaultDrawerDepth, height: settings.defaultDrawerHeight })}</div>
                <div>{t('layout:defaults.printBed', { size: settings.defaultPrintBedSize })}</div>
                <div>{t('layout:defaults.gridUnit', { size: settings.defaultGridUnitMm })}</div>
              </div>
              <button
                ...
                title={t('layout:defaults.saveAsDefaultsHint')}
              >
            ...
            <div className="px-4 py-4 border-t border-stroke-subtle text-content-disabled text-[10px] leading-relaxed">
              {t('layout:attribution.gridfinityBy')}{' '}
              <a
      ...
      <ConfirmDialog
        ...
        message={t('layout:defaults.saveAsDefaultsMessage', { width: drawerWidth, depth: drawerDepth, height: drawerHeight, printBed: printBedSize, gridUnit: gridUnitMm })}
